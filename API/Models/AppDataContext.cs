...
public class AppDataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>().HasData(
            ...
            new Categoria { CategoriaId = "39be53a2-fc09-3b6a-bafa-18a6a23c8f6e", Nome = "Lazer", CriadoEm = DateTime.Now.AddDays(3) }
        );
        ...
        modelBuilder.Entity<Tarefa>().HasData(
            ...
            new Tarefa { TarefaId = "2f1b7dc1-3b9a-4e1a-a389-7f5d2f1c8f3e", Titulo = "Estudar Angular", Descricao = "Preparar-se para a aula de Angular", CriadoEm = DateTime.Now.AddDays(4), CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d", Status = "Não iniciada" },
